        ...
        <div>
            <header className='header'>
                ...
                <nav className='header_nav'>
                    ...
                    <a href="https://www.linkedin.com/in/jegedeglory" className='header_social'>
                ...
                <div className="wrapper  hero_wrapper bottom_border">
                    ...
                    <picture>
                        ...
                        <source media="(min-width: 37.5em)" srcset={Picture646w} />
                            <img src={Picture890w}  className='hero_image' alt="picture of Adam"  width={174} height={383}/>
                    </picture>
                    <img src={Ring} alt="" width={530} height={129} className='hero_rings' />
                    <img src={Circle} alt="" width={129} height={129} className='hero_circle' />
                    <div className="hero_text">
                    <h1 className='hero_headline header_xl'>Welcome on board!
                       <br />  I'm <span>Jegede Glory</span></h1>
                    <p className='hero_description'>
                        Based in Nigeria, I'm a Software developer, aspiring to build &  learn new things about the web that users love
                    </p>
                    <a href="https://wa.link/slcgup" className='hero_contact underline' > Contact me</a>
                    </div>
                    </div>
                </div>
                </section>
                    <section className='skills'>
                        ...
                        <img src={Ring} alt="" width={530} height={129} className='skills_rings' />
                    </section>
                    <section className="projects">
                        <div className="wrapper projects_wrapper">
                            <div className="projects_grid">
                            <h2 className='projects_headline header_xl'>Projects</h2>
                            <a href="https://wa.link/slcgup" className='projects_contact underline' > Contact me</a>
                                <div className="projects_item">
                                    <picture className='projects_picture'>
                                        <source media='(min-width: 62.5em)'
                                        srcSet={AnimalDesign}/>
                                    <img src={AnimalDesign} alt="" width={343} height={253} className='projects_image'/>
                                    </picture>
                                    ...
                                    <div className="projects_links">
                                        <a href="/" className='underline'>View Project</a>
                                ...
                                <div className="projects_item">
                                    <picture className='projects_picture'>
                                        <source media='(min-width: 62.5em)'
                                        srcSet={SquidGame}/>
                                    <img src={SquidGame} alt="" width={343} height={253} className='projects_image'/>
                                    </picture>
                    ...
                    <section className='contact bg_less_dark'>
                        <div className="wrapper contact_wrapper bottom_border">
                            ...
                            <p className="contact_description">I would really love to hear about your project and how I can be of help.
                                Please, feel free to enlighten me about it and I will get back to you as soon as possible.
                            </p>
                            </div>
                            <form action="" ref={form} onSubmit={sendEmail} className="contact_form">
                                <div className="contact_control">
                                    <label htmlFor="name" className='visually_hidden'>Name</label>
                                    <input type="text" id='name' placeholder='Name' name='name' required/>
                                    <img src={Invalid} alt="" className="contact_invalid_icon" width={24} height={24} />
                                </div>
                                <div className="contact_control">
                                ...
                                <div className="contact_control">
                                    ...
                                    <textarea name="message" id="message" placeholder='Message' cols={30} rows={3} required></textarea>
                                    <img src={Invalid} alt="" className="contact_invalid_icon" width={24} height={24} />
                                </div>
                        ...
                        <img src={Ring} alt="" width={530} height={129} className='contact_rings' />
                    </section>
            </main>
